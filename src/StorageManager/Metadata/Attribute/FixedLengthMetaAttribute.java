...
public class FixedLengthMetaAttribute implements MetaAttribute {
    ...
    public FixedLengthMetaAttribute(String name, DataType type, boolean isPrimaryKey) {
        this.name = name;
        this.type = type;
     ...
     * @return byte arrays
     */
    public byte[] serialize(FixedLengthMetaAttribute metaAttribute) {
